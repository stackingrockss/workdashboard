...
/**
 * Column identifiers for Quarterly List table view
 * Same as CurrentQuarter but adds "quarter" column
 */
export type QuarterlyListColumnId =
  | "name"
  | "account"
  | "owner"
  | "quarter"
 ...
 */
export const QUARTERLY_COLUMN_CONFIGS: Record<QuarterlyListColumnId, ColumnConfig> = {
  name: {
    id: "name",
    label: "Opportunity",
    defaultVisible: true,
...
/**
 * Default column order for quarterly list view
 */
export const DEFAULT_QUARTERLY_COLUMN_ORDER: QuarterlyListColumnId[] = [
  "name",
  "account",
  "owner",
  "quarter",
...
/**
 * Factory function to create TanStack Table column definitions for quarterly list view
 */
export function createQuarterlyListColumns(
  ...
  return [
    ...
    // Quarter Column
    {
      ...
      cell: ({ row }) => (
        <span className="text-sm">{row.original.quarter || "-"}</span>
      ),
      meta: {
        className: "",
      },
